...
- [ ] **Visual code changed?** (renderers, themes, backgrounds, clouds, minimap, CSS) → Regenerate snapshots: `npx playwright test --update-snapshots` → stage updated PNGs. See `@agent-rules/e2e-testing.md`.
